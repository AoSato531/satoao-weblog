...
export default function Page() {
  return (
    ...
    >
      ...
      エンジニアをやっていてもあまり聴かない言葉でもあります。<br/>
      <br/>
      ...
      図示するとこんな感じです。ちなみに以降に例として出てくるシステムやRESTful APIは架空なので存在しません。<br/>
      <br/>
      <Image
        className="lg:w-[30vw] w-[75vw]"
      ...
      それに対してIDが3番である「さとう　あお」の情報を正常というステータスと一緒に、外部システムくんにレスポンスとして返しています。<br/>
      <br/>
      直感的にわかるかもしれませんが、この操作は1回やっても5回やっても1000回やっても同じ結果になります。<br/>
      レスポンスは常に同じなのはもちろん、データの取得しかしていないのでデータ状態も同じです。<br/>
      <br/>
      ...
      なぜかというと、データの状態が1回目も2回目も同じだからです。<br/>
      <br/>
